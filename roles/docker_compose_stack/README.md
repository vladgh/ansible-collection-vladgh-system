...
- `docker_compose_stack`: A list of stacks and their environment variables. It looks for a file with the same name in the `files/appstack/{{ inventory_hostname }}/` directory, relative to the directory where the playbook file is located
